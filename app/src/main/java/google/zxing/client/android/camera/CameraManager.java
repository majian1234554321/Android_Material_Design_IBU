...
import google.zxing.client.android.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	public CameraManager(Context context) {
		...
		if(screenWidth != 0){
			MAX_FRAME_WIDTH = (int) (screenWidth * 0.65f);
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		...
		reverseImage = false;// prefs.getBoolean(PreferencesActivity.KEY_REVERSE_IMAGE,
								// false);
	}
